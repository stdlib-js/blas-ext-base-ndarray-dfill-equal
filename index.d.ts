...
* });
*
* var out = dfillEqual( [ x, searchElement, alpha, start, end ] );
* // returns <ndarray>[ 5.0, -2.0, 3.0, 0.0, 4.0, -6.0 ]
*/
declare function dfillEqual( arrays: [ float64ndarray, typedndarray<number>, typedndarray<number>, typedndarray<number>, typedndarray<number> ] ): float64ndarray;
